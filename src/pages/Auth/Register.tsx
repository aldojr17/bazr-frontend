      ...
      <div className="auth-container row gap-5 gap-lg-0 flex-lg-row-reverse">
        <div className="col-12 col-lg-6 my-auto">
          <div className="mb-5">
            ...
            <p className="text-center fs-4">Get started by creating your new account</p>
          </div>
          <form onSubmit={handleSubmit} className="row flex-column align-items-center gy-4">
            <div className="col-lg-5 col-8 text-start">
              ...
              />
              {isError.fullname ? <div className="text-danger mt-3">Full Name should not be empty</div> : ""}
            </div>
            <div className="col-lg-5 col-8 text-start">
              <input
                className="form-control p-3"
                ...
                onChange={handleChange}
              />
              {isError.email ? <div className="text-danger mt-3">Email should not be empty</div> : ""}
            </div>
            <div className="col-lg-5 col-8 text-start">
              <input
                className="form-control p-3"
                ...
                onChange={handleChange}
              />
              {isError.password ? <div className="text-danger mt-3">Password should not be empty</div> : ""}
            </div>
            <div className="col-lg-5 col-8 text-start">
              <input
                className="form-control p-3"
              ...
              {isError.confirmPassword ? (
                <div className="text-danger mt-3">Confirm Password should not be empty</div>
              ) : (
                ""
              )}
              {isError.matchPassword ? (
                <div className="text-danger mt-3">Password and Confirm Password doesn't match</div>
              ) : (
                ""
              )}
            </div>
            <div className="col-lg-5 col-8 text-start">
              {apiError.error ? <div className="text-danger mt-3">{apiError.message}</div> : ""}
            </div>
        ...
        <div className="col-12 col-lg-6 my-auto p-0 pb-5 pb-lg-0">
          <div className="border border-1 w-75 mx-auto shadow py-5">
            <div className="row flex-column align-items-center text-center justify-content-center gap-5">
              <img src="/assets/register.svg" alt="register" className="img-thumbnail border-0 col-lg-7 col-8" />
