...
const HoverCart = ({ ...props }: IHoverCartProps) => {
  return (
    <HStack justifyContent={"space-between"} alignItems={"start"} spacing={5} width="100%">
      ...
      <Text as="span" fontWeight={"semibold"} textTransform={"capitalize"} noOfLines={1} textAlign={"start"} flex={"4"}>
        {props.name}
      </Text>
      <Text as="span" fontWeight={"semibold"} color={"purple.600"} noOfLines={1} textAlign={"end"} flex={"2"}>
